...
def computeAreaAndPerimeter(side1,side2,side3):
    assert (side1<side2+side3) and (side2<side1+side3) and (side3<side1+side2),"Error : Sum of two sides should be greater than third side"     # gives assertion error if sum of two side is less than third side
